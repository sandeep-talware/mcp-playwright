...
export class PlaywrightSession {
  constructor(browser, sessionId) {
    ...
    this.context = null;
    this.page = null;
    this.logger = new Logger(`PlaywrightSession:${sessionId}`);
  ...
  /**
   * Ensures the session is initialized before operations
  ...
  async initialize() {
    try {
      ...
      if (config.playwright.startMaximized) {
        // viewport: null is required for --start-maximized to work effectively
